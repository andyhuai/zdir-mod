...
<head>
    <style type="text/css">
	    ...
	    button{border:0;background:#009688;color:#fff;cursor:pointer;opacity:1;user-select:none}
	    button:hover,button:focus{opacity:.9}
	    button:active{opacity:1}
	    .main{max-width:400px;height:100px;padding:30px;background-color:#fff;border-radius:2px;box-shadow:0 10px 60px 0 rgba(29,29,31,0.09);transition:all .12s ease-out;position:absolute;left:0;top:0;bottom:0;right:0;margin:auto;text-align:center}
	    .alert{width:80px}
	    ...
	    .return-home:hover{color:#009688;}
    </style>
</head>
<body>
    <div class="main">
        ...
        <form action="" method="post" class="mk-side-form">
            <!--<h2 class="pw-tip">该目录资源需要密码才能访问</h2>-->
